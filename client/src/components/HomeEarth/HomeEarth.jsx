                ...
                <Card>
                  ...
                  <Accordion.Collapse eventKey="0">
                    <Card.Body className="selection-body">
                      ...
                      <div className="card-selection" data-country="finland">芬蘭</div>
                      <div className="card-selection" data-country="greenland">格陵蘭</div>
                      <div className="card-selection" data-country="iceland">冰島</div>
                      <div className="card-selection" data-country="spitzberg">斯匹次卑爾根</div>
                    </Card.Body>
                  </Accordion.Collapse>
                </Card>
              </Accordion>
